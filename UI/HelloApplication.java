...
public class HelloApplication extends Application {
    ...
    private Node createToolbar() {
        ...
        cbtemps.getItems().addAll(256,512,1024);
        ...
        button2.setOnAction(actionEvent -> {AudioIO.stop_Audio_Processing();});
        button1.setOnAction(actionEvent -> {AudioProcessor.Lance_fft(sigfreq,true);});
        return tb;
    }
    ...
    private Node createSigtemp() {
        NumberAxis xAxis = new NumberAxis(0, 2048, 16);
